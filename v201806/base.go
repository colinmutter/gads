...
type Paging struct {
	Offset int64 `xml:"https://adwords.google.com/api/adwords/cm/v201806 startIndex"`
	Limit  int64 `xml:"https://adwords.google.com/api/adwords/cm/v201806 numberResults"`
}
...
// https://developers.google.com/adwords/api/docs/reference/v201806/AdGroupExtensionSettingService.DayOfWeek
// Days of the week.
// MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY
type DayOfWeek string

// https://developers.google.com/adwords/api/docs/reference/v201806/AdGroupExtensionSettingService.MinuteOfHour
// Minutes in an hour. Currently only 0, 15, 30, and 45 are supported
// ZERO, FIFTEEN, THIRTY, FORTY_FIVE
type MinuteOfHour string

// https://developers.google.com/adwords/api/docs/reference/v201806/AdGroupExtensionSettingService.GeoRestriction
...
// https://developers.google.com/adwords/api/docs/reference/v201806/AdGroupExtensionSettingService.PolicyData
// Approval and policy information attached to an entity.
type PolicyData struct {
	DisapprovalReasons []DisapprovalReason `xml:"https://adwords.google.com/api/adwords/cm/v201806 disapprovalReasons,omitempty"`
	PolicyDataType     string              `xml:"https://adwords.google.com/api/adwords/cm/v201806 PolicyData.Type,omitempty"`
}

// https://developers.google.com/adwords/api/docs/reference/v201806/AdGroupExtensionSettingService.DisapprovalReason
// Container for information about why an AdWords entity was disapproved.
type DisapprovalReason struct {
	ShortName string `xml:"https://adwords.google.com/api/adwords/cm/v201806 shortName,omitempty"`
}
